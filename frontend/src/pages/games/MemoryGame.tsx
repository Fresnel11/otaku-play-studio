...
// Backgrounds
const narutoBackground = ASSETS.IMAGES.NARUTO;
const multiverseBackground = ASSETS.IMAGES.MULTIVERSE;
const demonSlayerBackground = ASSETS.IMAGES.DEMON_SLAYER;
...
const MemoryGame: React.FC = () => {
    ...
    const universes: { id: Universe; label: string; bg: string }[] = [
        ...
        { id: 'one-piece', label: 'One Piece', bg: ASSETS.IMAGES.ONE_PIECE },
